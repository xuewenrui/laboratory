...
const MemberDetail = () => {
    ...
    const member = {
        ...
        education: ["2012-2016Aarhus University, Denmark Ph.D. in Genetics"],
        workExperience:['2023–Now Professor, UESTC, P. R. China','2019–2023 Assistant/Associate Professor, Chinese Academy of Sciences, P. R. China','2018–2019 Postdoc, Cornell University, United States'],
        publications:[
            ...
            <Layout.Content style={{ margin: '20px' }}>
                ...
                >
                    ...
                    >
                        ...
                        {/* 个人经历 */}
                        {member.personalExperience && member.personalExperience.length > 0 ? (
                            <CustomTabPane tab="个人经历" key="personalExperience">
                                {member.personalExperience.map((p, index) => (
                                    <p key={index} className="tab-paragraph">{p}</p>
                                ))}
